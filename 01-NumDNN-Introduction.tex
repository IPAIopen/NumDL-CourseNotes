...
\begin{center}
	\begin{tabular}{cc}
		$\bfy_1$ & $\bfy_2$\\
	\includegraphics[width=30mm]{maybe4.jpg} &
	\includegraphics[width=30mm]{maybe7.jpg} \\
...
% section introduction_to_deep_neural_networks (end)
